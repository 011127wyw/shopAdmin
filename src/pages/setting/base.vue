        ...
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="强制密码复杂度">
            <el-checkbox-group v-model="form.password_encrypt">
              ...
              <el-checkbox label="3" border> 字符 </el-checkbox>
            </el-checkbox-group>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="上传设置" name="second">
          <el-form-item label="默认上传方式">
            <el-radio v-model="form.upload_method" border>阿里oss</el-radio>
          </el-form-item>
          ...
          <el-form-item label="空间域名">
            <el-input
              ...
              style="width: 30%"
            />
            <small class="text-gray-400 ml-2">请补全 http:// 或 https://</small>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="Api安全" name="third">
          <el-form-item label="API安全">
            <el-radio-group v-model="form.api_safe">
              <el-radio :label="1" border> 开启 </el-radio>
              <el-radio :label="0" border> 关闭 </el-radio>
            </el-radio-group>
            <small class="text-gray-400 ml-3"
              >API安全功能开启之后调用前端API需要传输签名串</small
            >
          </el-form-item>
          <el-form-item label="密钥" class="flex items-center">
            <el-input
              v-model="form.api_secret"
              placeholder="密钥类型:12231341551"
              style="width: 30%"
            ></el-input>
            <small class="text-gray-400">
              密钥设置关系系统中API调用传输名单的编码规则,以及会员token解析,请慎重设置,注意设置之后对应会员要求重新登录获取token
            </small>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>
